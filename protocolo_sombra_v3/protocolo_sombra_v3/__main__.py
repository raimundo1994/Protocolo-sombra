#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Ponto de entrada do Protocolo Sombra v3.0"""
...
from protocolo_sombra_v3.engine.motor import MotorJogo
from protocolo_sombra_v3.ui.terminal import C, mensagem_eva
